...
### [H1 — Intimacy (functional re-coding)](#h1) — 98 topics

- [58 — Coping With A Damaged Limb](#topic-h1-58) — I0 — off target
- [57 — Hands Raised in Reassuring Gesture](#topic-h1-57) — I0 — off target
- [11 — Eyes Meeting Across The Room](#topic-h1-11) — I10 — eroticized gaze
- [19 — Legs Wrapped Around His Waist](#topic-h1-19) — I3 — nonexplicit affection
- [25 — Crawling Onto The Bed Together](#topic-h1-25) — I0 — off target
- [72 — Complimenting Her Beauty Aloud](#topic-h1-72) — I10 — eroticized gaze
- [98 — Stepping Out of The Shower](#topic-h1-98) — I0 — off target
- [104 — Stepping Out of Panties and Jeans](#topic-h1-104) — I4 — sexual tension
- [135 — Waiting As Long As It Takes](#topic-h1-135) — I4 — sexual tension
- [139 — Admiring Her Grace and Beauty](#topic-h1-139) — I10 — eroticized gaze
- [155 — Stop Running or Be Claimed](#topic-h1-155) — I4 — sexual tension
- [165 — Confessing Long-Simmering Desire](#topic-h1-165) — I4 — sexual tension
- [196 — Promising to Be A Good Team](#topic-h1-196) — MIXED
- [245 — Lip Biting and Nervous Pout](#topic-h1-245) — I4 — sexual tension
- [279 — Blue Eyes Darkening With Invitation](#topic-h1-279) — I10 — eroticized gaze
- [337 — Adjusting to His Presence Inside Her](#topic-h1-337) — I4 — sexual tension
- [352 — Daring Someone to Try](#topic-h1-352) — I2 — reassurance
- [353 — Joking About Being Naked](#topic-h1-353) — I5 — erotic escalation
- [365 — Frantic Longing After Weeks Apart](#topic-h1-365) — MIXED
- [370 — Tattoos Revealed and Judged](#topic-h1-370) — I10 — eroticized gaze
...
- [197 — Lingering Farewell Kiss](#topic-h1-197) — MIXED
- [1 — Straps Sliding Down Her Arms](#topic-h1-1) — MIXED
- [7 — Kissing With Tongue and Urgency](#topic-h1-7) — MIXED
- [41 — Gripping Her Neck and Pulling Close](#topic-h1-41) — MIXED
- [63 — Cupping and Pinching Her Nipples](#topic-h1-63) — I6 — explicit sex
- [208 — Pounded Into The Mattress](#topic-h1-208) — I6 — explicit sex
- [230 — Tongue and Hands After Climax](#topic-h1-230) — I4 — sexual tension
- [292 — Erection Straining Against His Trousers](#topic-h1-292) — I6 — explicit sex
- [55 — Worrying About An Unplanned Pregnancy](#topic-h1-55) — I8 — negotiation
- [125 — Furnished Room Described in Detail](#topic-h1-125) — I8 — negotiation
- [151 — Agreeing to Stop When Asked](#topic-h1-151) — I8 — negotiation
- [156 — Reaching Into The Bedside Drawer](#topic-h1-156) — MIXED
- [203 — Stepping Into The Bathroom](#topic-h1-203) — I8 — negotiation
- [213 — Choosing Sex Without Commitment](#topic-h1-213) — I5 — erotic escalation
- [227 — Cherishing Memories Before Parting](#topic-h1-227) — I0 — off target
- [38 — Admitting Shared Pain](#topic-h1-38) — I2 — reassurance
- [52 — Talking About Dogs and Animals](#topic-h1-52) — I0 — off target
- [54 — Ordering Food and Dessert](#topic-h1-54) — I0 — off target
- [86 — First Name Used at Last](#topic-h1-86) — I0 — off target
- [93 — Meal Plans Casually Arranged](#topic-h1-93) — I0 — off target
- [105 — Swept Onto The Dance Floor](#topic-h1-105) — I0 — off target
- [116 — Sharing A Meal Together](#topic-h1-116) — I0 — off target
- [160 — Watching Movies Together](#topic-h1-160) — I0 — off target
- [174 — Ranch Life and Falling in Love](#topic-h1-174) — I0 — off target
- [232 — Conversation Cut Short By Arrival](#topic-h1-232) — I2 — reassurance
- [330 — Curious About Her Cooking Skills](#topic-h1-330) — I0 — off target
- [332 — First Time Inside A Grocery Store](#topic-h1-332) — I0 — off target
- [351 — Warm Greeting Upon Return](#topic-h1-351) — I0 — off target
- [367 — Sorting Out Concert Tickets](#topic-h1-367) — I0 — off target
- [37 — Defending A Close Friendship](#topic-h1-37) — I1 — emotional intimacy
- [24 — Confronting An Unwanted Marriage](#topic-h1-24) — I0 — off target
- [85 — Offering and Refusing An Apology](#topic-h1-85) — I2 — reassurance
- [29 — Confessing Long-Held Love](#topic-h1-29) — I1 — emotional intimacy
- [62 — Admitting You've Been Stupid](#topic-h1-62) — I0 — off target
- [65 — Declaring A True Partnership](#topic-h1-65) — I0 — off target
- [128 — Confessing How Much You've Missed](#topic-h1-128) — I2 — reassurance
- [157 — Swearing to Save Him From Himself](#topic-h1-157) — I0 — off target
- [204 — Promising to Care For Her Sister](#topic-h1-204) — I0 — off target
- [242 — Trading Forgiveness For Old Wrongs](#topic-h1-242) — I2 — reassurance
- [305 — Confessing A Lifelong Regret](#topic-h1-305) — I2 — reassurance
- [6 — Whispered Reassurance](#topic-h1-6) — I2 — reassurance
- [31 — Keeping Watch While Others Sleep](#topic-h1-31) — I0 — off target
- [36 — Eagerly Offering to Help](#topic-h1-36) — I2 — reassurance
- [45 — Reassured Everything Will Be Fine](#topic-h1-45) — I2 — reassurance
- [46 — Asking Someone to Trust You](#topic-h1-46) — I2 — reassurance
- [56 — Promising Never to Hurt You](#topic-h1-56) — I2 — reassurance
- [70 — Keeping Watch While She Sleeps](#topic-h1-70) — I0 — off target
- [83 — Reassured About Eating Regularly](#topic-h1-83) — I0 — off target
- [88 — Checking Her Feverish Temperature](#topic-h1-88) — I2 — reassurance
- [96 — Confessing Long-Standing Worry](#topic-h1-96) — I2 — reassurance
- [119 — Offering to Keep Her Safe](#topic-h1-119) — I2 — reassurance
- [161 — Reassuring Squeeze on The Shoulder](#topic-h1-161) — I2 — reassurance
- [172 — Reporting to The Security Officer](#topic-h1-172) — I0 — off target
- [173 — Waiting For Him to Wake](#topic-h1-173) — I0 — off target
- [175 — Gentleman Offers Steadying Support](#topic-h1-175) — I2 — reassurance
- [190 — Offering to Get Someone Cleaned Up](#topic-h1-190) — I0 — off target
- [193 — Nurse Arranged After Hospital Release](#topic-h1-193) — I0 — off target
- [224 — Encouraging Words From An Angel](#topic-h1-224) — I2 — reassurance
- [240 — Unsure How to Offer Comfort](#topic-h1-240) — I2 — reassurance
- [247 — Promising You Will Not Be Alone](#topic-h1-247) — I0 — off target
- [273 — Mentor Gives Firm Instructions](#topic-h1-273) — I2 — reassurance
- [277 — Promising to Handle The Lawyer](#topic-h1-277) — I0 — off target
- [289 — Quick Peck on The Forehead](#topic-h1-289) — I2 — reassurance
- [299 — Pledging to Have Your Back](#topic-h1-299) — I2 — reassurance
- [307 — Hauling Someone Up The Stairs](#topic-h1-307) — I2 — reassurance
- [340 — Patience Tested Through Small Trials](#topic-h1-340) — I2 — reassurance
- [355 — Blanket Draped Over Someone](#topic-h1-355) — I2 — reassurance
- [356 — Admitting Exhaustion After A Long Day](#topic-h1-356) — I2 — reassurance
- [358 — Reassuring Squeeze of The Hand](#topic-h1-358) — I2 — reassurance
- [372 — Told to Keep Up Strength](#topic-h1-372) — I2 — reassurance
- [82 — Touch Her and Your Family Suffers](#topic-h1-82) — MIXED
- [199 — Shoved to His Knees](#topic-h1-199) — I0 — off target
- [345 — Older Man Trading Shelter For Sex](#topic-h1-345) — I9 — coercive sexuality
- [61 — Planning to Exchange Rings](#topic-h1-61) — MIXED
- [100 — Promising to Find Her](#topic-h1-100) — I0 — off target
...
| --- | --- | --- |
| `I0` | **off target** | Not about romantic intimacy as defined below. Includes domestic errands, meals, animals, logistics, medical care, mentoring, generic plot talk, and non-romantic help. Prefer I0 over stretching any intimacy code. |
| `I1` | **emotional intimacy** | Disclosure, vulnerability, shared secrets, emotional closeness WITHOUT physical contact and WITHOUT reassurance-as-comfort as the main act. |
| `I2` | **reassurance** | Comforting, soothing, affirming safety/worth/the bond ("you'll be fine", "I won't hurt you", fever checks, watch-while-sleeping caretalk). Not kissing/holding. |
| `I3` | **nonexplicit affection** | ONLY when the dominant content is affectionate physical contact that is NOT genital/oral/penetrative: kissing, hugging, holding, caressing, undressing-as-prelude, non-genital touch. Ban I3 if there is no such contact in keywords/sentences. Kissing/clothes-removal alone are I3, never I6. |
| `I4` | **sexual tension** | Desire, anticipation, charged looking/invitation WITHOUT consummation and WITHOUT affectionate contact as the main act (eyes meeting, lip biting, longing, "want you"). |
| `I5` | **erotic escalation** | Building toward sex; heated undressing/touch progressing toward an explicit act, but not yet full explicit-sex focus. |
| `I6` | **explicit sex** | Explicit sexual acts (genital contact, oral sex, penetration, orgasm-focused intercourse). Do NOT code kissing, undressing, or non-genital caressing as I6 — those are I3. |
| `I7` | **aftercare** | Post-sex tenderness, checking in, bonding immediately after intimacy. |
| `I8` | **negotiation** | Consent talk, boundaries, stop-when-asked, preferences about intimacy/sex. |
| `I9` | **coercive sexuality** | Pressure, force, non-consent, or ambiguous consent around sex. |
| `I10` | **eroticized gaze** | Objectifying / erotic looking or appearance-focused desire without mutual intimacy or affectionate contact (watching body, beauty compliments as erotic appraisal). |

Topics with a non-null `intimacy_code`: **98**. Sentence tags use the unblinded cell key (`high_tier` → HIGH-rated, `low_tier` → LOW-rated).

| Topic | Old taxonomy | New category | Mixed |
| --- | --- | --- | --- |
| 58 — Coping With A Damaged Limb | 1.2 — Pain, Injury & Physical Vulnerability | I0 — off target | False |
| 57 — Hands Raised in Reassuring Gesture | 1.7 — Facial Expression & Non-Sexual Nonverbal Cues | I0 — off target | False |
| 11 — Eyes Meeting Across The Room | 2.1 — Attraction & Sexual Tension | I10 — eroticized gaze | False |
| 19 — Legs Wrapped Around His Waist | 2.1 — Attraction & Sexual Tension | I3 — nonexplicit affection | False |
| 25 — Crawling Onto The Bed Together | 2.1 — Attraction & Sexual Tension | I0 — off target | False |
| 72 — Complimenting Her Beauty Aloud | 2.1 — Attraction & Sexual Tension | I10 — eroticized gaze | False |
| 98 — Stepping Out of The Shower | 2.1 — Attraction & Sexual Tension | I0 — off target | False |
| 104 — Stepping Out of Panties and Jeans | 2.1 — Attraction & Sexual Tension | I4 — sexual tension | False |
| 135 — Waiting As Long As It Takes | 2.1 — Attraction & Sexual Tension | I4 — sexual tension | False |
| 139 — Admiring Her Grace and Beauty | 2.1 — Attraction & Sexual Tension | I10 — eroticized gaze | False |
| 155 — Stop Running or Be Claimed | 2.1 — Attraction & Sexual Tension | I4 — sexual tension | False |
| 165 — Confessing Long-Simmering Desire | 2.1 — Attraction & Sexual Tension | I4 — sexual tension | False |
| 196 — Promising to Be A Good Team | 2.1 — Attraction & Sexual Tension | MIXED | True |
| 245 — Lip Biting and Nervous Pout | 2.1 — Attraction & Sexual Tension | I4 — sexual tension | False |
| 279 — Blue Eyes Darkening With Invitation | 2.1 — Attraction & Sexual Tension | I10 — eroticized gaze | False |
| 337 — Adjusting to His Presence Inside Her | 2.1 — Attraction & Sexual Tension | I4 — sexual tension | False |
| 352 — Daring Someone to Try | 2.1 — Attraction & Sexual Tension | I2 — reassurance | False |
| 353 — Joking About Being Naked | 2.1 — Attraction & Sexual Tension | I5 — erotic escalation | False |
| 365 — Frantic Longing After Weeks Apart | 2.1 — Attraction & Sexual Tension | MIXED | True |
| 370 — Tattoos Revealed and Judged | 2.1 — Attraction & Sexual Tension | I10 — eroticized gaze | False |
| 101 — Smoothing Loose Strands of Hair | 2.2 — Kissing & Non-Explicit Affection | I3 — nonexplicit affection | True |
...
| 197 — Lingering Farewell Kiss | 2.2 — Kissing & Non-Explicit Affection | MIXED | True |
| 1 — Straps Sliding Down Her Arms | 2.3 — Explicit Sexual Acts | MIXED | True |
| 7 — Kissing With Tongue and Urgency | 2.3 — Explicit Sexual Acts | MIXED | True |
| 41 — Gripping Her Neck and Pulling Close | 2.3 — Explicit Sexual Acts | MIXED | True |
| 63 — Cupping and Pinching Her Nipples | 2.3 — Explicit Sexual Acts | I6 — explicit sex | False |
| 208 — Pounded Into The Mattress | 2.3 — Explicit Sexual Acts | I6 — explicit sex | True |
| 230 — Tongue and Hands After Climax | 2.3 — Explicit Sexual Acts | I4 — sexual tension | False |
| 292 — Erection Straining Against His Trousers | 2.3 — Explicit Sexual Acts | I6 — explicit sex | False |
| 55 — Worrying About An Unplanned Pregnancy | 2.5 — Sexual Negotiation, Safety Preparation & Boundaries | I8 — negotiation | False |
| 125 — Furnished Room Described in Detail | 2.5 — Sexual Negotiation, Safety Preparation & Boundaries | I8 — negotiation | False |
| 151 — Agreeing to Stop When Asked | 2.5 — Sexual Negotiation, Safety Preparation & Boundaries | I8 — negotiation | True |
| 156 — Reaching Into The Bedside Drawer | 2.5 — Sexual Negotiation, Safety Preparation & Boundaries | MIXED | True |
| 203 — Stepping Into The Bathroom | 2.5 — Sexual Negotiation, Safety Preparation & Boundaries | I8 — negotiation | False |
| 213 — Choosing Sex Without Commitment | 2.5 — Sexual Negotiation, Safety Preparation & Boundaries | I5 — erotic escalation | False |
| 227 — Cherishing Memories Before Parting | 2.5 — Sexual Negotiation, Safety Preparation & Boundaries | I0 — off target | False |
| 38 — Admitting Shared Pain | 4.2 — Ongoing Courtship & Everyday Relational Bonding | I2 — reassurance | True |
| 52 — Talking About Dogs and Animals | 4.2 — Ongoing Courtship & Everyday Relational Bonding | I0 — off target | True |
...
| 105 — Swept Onto The Dance Floor | 4.2 — Ongoing Courtship & Everyday Relational Bonding | I0 — off target | True |
...
| 174 — Ranch Life and Falling in Love | 4.2 — Ongoing Courtship & Everyday Relational Bonding | I0 — off target | True |
...
| 332 — First Time Inside A Grocery Store | 4.2 — Ongoing Courtship & Everyday Relational Bonding | I0 — off target | True |
...
| 62 — Admitting You've Been Stupid | 4.5 — Reconciliation, Commitments & HEA | I0 — off target | True |
| 65 — Declaring A True Partnership | 4.5 — Reconciliation, Commitments & HEA | I0 — off target | True |
| 128 — Confessing How Much You've Missed | 4.5 — Reconciliation, Commitments & HEA | I2 — reassurance | True |
| 157 — Swearing to Save Him From Himself | 4.5 — Reconciliation, Commitments & HEA | I0 — off target | True |
| 204 — Promising to Care For Her Sister | 4.5 — Reconciliation, Commitments & HEA | I0 — off target | False |
| 242 — Trading Forgiveness For Old Wrongs | 4.5 — Reconciliation, Commitments & HEA | I2 — reassurance | False |
...
| 31 — Keeping Watch While Others Sleep | 4.6 — Emotional Safety, Reassurance & Caretaking | I0 — off target | True |
...
| 56 — Promising Never to Hurt You | 4.6 — Emotional Safety, Reassurance & Caretaking | I2 — reassurance | False |
| 70 — Keeping Watch While She Sleeps | 4.6 — Emotional Safety, Reassurance & Caretaking | I0 — off target | False |
| 83 — Reassured About Eating Regularly | 4.6 — Emotional Safety, Reassurance & Caretaking | I0 — off target | True |
| 88 — Checking Her Feverish Temperature | 4.6 — Emotional Safety, Reassurance & Caretaking | I2 — reassurance | True |
...
| 190 — Offering to Get Someone Cleaned Up | 4.6 — Emotional Safety, Reassurance & Caretaking | I0 — off target | True |
...
| 240 — Unsure How to Offer Comfort | 4.6 — Emotional Safety, Reassurance & Caretaking | I2 — reassurance | True |
| 247 — Promising You Will Not Be Alone | 4.6 — Emotional Safety, Reassurance & Caretaking | I0 — off target | True |
...
| 100 — Promising to Find Her | 9.2 — Promise, Vow & Future-Tense Speech Acts | I0 — off target | False |

### Topic 58 — Coping With A Damaged Limb {#topic-h1-58}

- **Old taxonomy:** 1.2 — Pain, Injury & Physical Vulnerability
...
> if we can’t get you a flesh-and-bone arm back i promise we’ll get you a laser at least in our design.” “

> i’ve been coping on my own for two months and it’ll be good to have another pair of hands.’ ‘

> if you’d let go of my arm, we’ll gladly get the hell out of here.”

**Novel sentences** (HIGH-rated / LOW-rated from unblinded sampling cells)

> **HIGH-rated (low topic share in this book; was CELL_C) · BOOK_001 · Secondhand Bride — Linda Lael Miller; tertile=middle; p=0.72**
>
> So you might as well put up your hands.”

> **HIGH-rated (low topic share in this book; was CELL_C) · BOOK_001 · Secondhand Bride — Linda Lael Miller; tertile=begin; p=0.53**
>
> Ten fingers, ten toes, and a healthy set of lungs!”

> **HIGH-rated (low topic share in this book; was CELL_C) · BOOK_001 · Secondhand Bride — Linda Lael Miller; tertile=end; p=0.45**
>
> His knees might as well have been made of water as muscle and bone; If he tried to stand on his feet, like as not he’d pitch over in a swoon and get a mouthful of dirt for a bonus.

> **HIGH-rated (low topic share in this book; was CELL_C) · BOOK_001 · Secondhand Bride — Linda Lael Miller; tertile=end; p=0.44**
>
> I’ve only got one good arm, you know,” he said lamely.

> **HIGH-rated (low topic share in this book; was CELL_C) · BOOK_001 · Secondhand Bride — Linda Lael Miller; tertile=end; p=0.43**
>
> One of the hands fished that poor gal out of the creek day before yesterday.

> **LOW-rated (high topic share in this book; was CELL_B) · BOOK_002 · 30 Guys in 30 Days — Micol Ostow; tertile=middle; p=0.63**
>
> Without warning, his hand slid up my leg.

> **LOW-rated (high topic share in this book; was CELL_B) · BOOK_002 · 30 Guys in 30 Days — Micol Ostow; tertile=end; p=0.62**
>
> I, of course, just wanted to stretch my legs. “

> **LOW-rated (high topic share in this book; was CELL_B) · BOOK_002 · 30 Guys in 30 Days — Micol Ostow; tertile=middle; p=0.58**
>
> Once I was standing, the arms made their way to my hips and spun me around. “

> **LOW-rated (high topic share in this book; was CELL_B) · BOOK_002 · 30 Guys in 30 Days — Micol Ostow; tertile=middle; p=0.57**
>
> Suddenly long arms were stretched around my waist from behind me, lifting me up off of the ground.

> **LOW-rated (high topic share in this book; was CELL_B) · BOOK_002 · 30 Guys in 30 Days — Micol Ostow; tertile=begin; p=0.56**
>
...
- **Pass A — lexical:** **I0 — off target**
  - All keyword sets point to physical injury/mobility context: lower-body anatomy (legs, knees, feet, ankle, ankles), pain cues (hurts, painful, stumbled, struggled), and procedural/instructional language (instructions, braced, ripping, reminder, concrete). This is injury/recovery or physical-assistance content with no affectionate-contact cues (no kiss, hug, caress, or undressing). I3 is rejected for lack of any affectionate physical contact. I6/I4/I10 are rejected for absence of erotic or sexual cues. The dominant function is practical/logistical/caretaking at most, coded I0 (domestic/logistical/non-intimate interaction).
- **Pass B — contextual:** **I0 — off target**
  - The overwhelming majority of sentences reference body parts (arms, legs, hands, feet, fingers, toes) in non-intimate, functional, or descriptive contexts — injury, physical capability, logistics, or neutral observation — coded I0. Three sentences from BOOK_002 show actual affectionate/physical contact: a hand sliding up a leg (I3), arms spinning the narrator at the hips (I3), and arms lifting the narrator from behind (I3). These are non-genital physical contact qualifying as I3. No explicit sexual acts, desire-without-contact, or erotic gaze are present. I0 dominates at ~85%.
- **Pass C — adjudication:** **I0 — off target**
  - Lexical and contextual consensus both indicate I0. The taxonomy confirms this cluster centers on physical vulnerability and caretaking/reassurance — neither of which requires affectionate physical contact to function narratively. No kissing, hugging, holding, caressing, or undressing-as-prelude is evidenced. The secondary construct (4.6 Emotional Safety, Reassurance & Caretaking) is consistent with I2 adjacency, but without contact evidence the anti-collapse rules prohibit elevation to I3. I0 is the correct and most specific code for domestic/care/HEA-adjacent content without physical intimacy contact. No split or reinterpretation is warranted.

---

### Topic 57 — Hands Raised in Reassuring Gesture {#topic-h1-57}
...
> **LOW-rated (low topic share in this book; was CELL_D) · BOOK_001 · Ultimatum: Marriage — Ann Major; tertile=begin; p=0.72**
>
> Grinning, he held up his hands in a gesture of mock innocence. “

> **LOW-rated (low topic share in this book; was CELL_D) · BOOK_001 · Ultimatum: Marriage — Ann Major; tertile=begin; p=0.71**
>
> Her slim fingers that gripped his arm for support shook.

> **LOW-rated (low topic share in this book; was CELL_D) · BOOK_001 · Ultimatum: Marriage — Ann Major; tertile=end; p=0.70**
>
> Jake clenched his hands, then forced himself to unclench them. “

> **LOW-rated (low topic share in this book; was CELL_D) · BOOK_001 · Ultimatum: Marriage — Ann Major; tertile=middle; p=0.33**
>
> Luckily a couple of the reporters made themselves useful and tackled him.

> **LOW-rated (high topic share in this book; was CELL_B) · BOOK_003 · Capture You — Penelopye L Ericksen; tertile=begin; p=0.77**
>
> He brought up his hand and covered his face with it. “

> **LOW-rated (high topic share in this book; was CELL_B) · BOOK_003 · Capture You — Penelopye L Ericksen; tertile=end; p=0.73**
>
> He shook his head slightly and lifted an unsteady hand to his face.

> **LOW-rated (high topic share in this book; was CELL_B) · BOOK_003 · Capture You — Penelopye L Ericksen; tertile=begin; p=0.72**
>
> he said quietly before letting his hand drop.

**Model reasonings (new taxonomy audits)**

- **Pass A — lexical:** **I5 — erotic escalation**
...
- **New category:** **I10 — eroticized gaze**
- **Mixed:** False
- **Adjudication action:** `KEEP`
...
- **Pass A — lexical:** **I10 — eroticized gaze**
...
- **Pass B — contextual:** **I10 — eroticized gaze**
...
- **Pass C — adjudication:** **I10 — eroticized gaze**
...
- **Pass A — lexical:** **I10 — eroticized gaze**
  - All four keyword lists converge on erotic/aesthetic gaze and appraisal of appearance: Main has 'beautiful, look, ugly, cute, perfect, sexy, pretty'; KeyBERT has 'attractive, stunning, exquisite, graceful, attracted'; POS adds 'pout, stunning, attractive, graceful, exquisite'; MMR adds 'pout, attractive, graceful, exquisite'. The dominant function is visual/evaluative admiration of physical appearance — classic erotic gaze (I10). 'Pout' across POS and MMR reinforces a focus on physical features being observed. There is no lexical evidence of affectionate physical contact (no kiss, hug, hold, caress, or undressing cues), so I3 is rejected. Desire without contact cues (e.g., 'attracted') could suggest I4, but the overwhelming weight of appearance-appraisal vocabulary ('look', 'beautiful', 'sexy', 'stunning', 'exquisite', 'pout') points specifically to erotic gaze (I10) rather than internal desire alone.
- **Pass B — contextual:** **I10 — eroticized gaze**
  - Every sentence in this topic involves verbal or observational appraisal of physical appearance — comments on eyes, beauty, pallor, resemblance, loveliness — with no affectionate physical contact present. This is the erotic/appreciative gaze function (I10): characters remarking on how someone looks, not touching them. I3 is forbidden because no kiss, hug, hold, caress, or undressing occurs. I4 (desire without contact) is less specific than I10 here because the sentences are aesthetic/visual appraisals rather than expressions of longing or desire. I10 is the most specific code for appearance-focused commentary.
- **Pass C — adjudication:** **I10 — eroticized gaze**
  - Both lexical and contextual consensus converge on I10 (erotic gaze). The taxonomy confirms primary placement in Attraction & Sexual Tension with secondary Character Appearance & Self-Presentation, consistent with visual appraisal and desire-without-contact dynamics. No affectionate physical contact (kiss, hug, hold, caress, or undress-as-prelude) is evidenced, so I3 is forbidden. The topic does not involve explicit sex (I6), consent negotiation (I8), coercion (I9), reassurance/caretaking (I2), or domestic/HEA logistics (I0). I10 is the most specific and accurate code. No split or reinterpretation is warranted.
...
- **Pass A — lexical:** **I0 — off target**
  - All keyword lists point to a mundane bathing/hygiene scene: shower, towel, tub, bath, bathroom, curtain, washed, dried, damp, wiping, dripping, draped, neatly. POS adds 'longing' and 'flush' which could hint at emotional undercurrent, and MMR adds 'longing' and 'shed', but these are isolated cues insufficient to establish affectionate physical contact. There is no kissing, hugging, caressing, or undressing-as-prelude present. I3 is rejected because no affectionate-contact cues appear. The scene reads as domestic/logistical self-care routine, coding to I0.
- **Pass B — contextual:** **I0 — off target**
  - The overwhelming majority of sentences describe mundane bathing, showering, and grooming activities with no interpersonal intimacy — coded I0 (domestic/logistical). Three sentences contain actual affectionate physical contact: BOOK_003_1 ('stepped from the tub with her' — shared physical presence/contact), BOOK_005_1 ('scooped her up in his arms' — holding/carrying), and BOOK_005_3 ('began washing him' — caressing/non-genital physical contact). These qualify for I3 under the kissing/non-genital caress criterion. No erotic gaze, desire-without-contact, or explicit sexual acts are present. I0 dominates at ~85%.
- **Pass C — adjudication:** **I0 — off target**
  - Lexical and contextual consensus both indicate I0. The taxonomy flags Attraction & Sexual Tension (2.1) with a secondary of Body Parts & Physical Reactions (1.1), which is consistent with desire/gaze/tension without affectionate physical contact. No evidence of kissing, hugging, holding, caressing, or undressing-as-prelude; I3 is therefore forbidden. The secondary physical-reactions signal could suggest I4 (desire without contact) or I10 (erotic gaze), but without stronger contextual evidence to override the dual-pass I0 consensus, the classification remains I0. No collapse into I3 is warranted.
...
- **Pass C — adjudication:** **I4 — sexual tension**
...
- **Pass A — lexical:** **I4 — sexual tension**
...
- **Pass A — lexical:** **I9 — coercive sexuality**
...
- **Pass B — contextual:** **I4 — sexual tension**
...
- **Pass B — contextual:** **I2 — reassurance**
...
- **Pass C — adjudication:** **I2 — reassurance**
...
- **Old taxonomy:** 2.1 — Attraction & Sexual Tension
- **New category:** **I5 — erotic escalation**
- **Mixed:** False
- **Adjudication action:** `KEEP`
...
- **Pass B — contextual:** **I5 — erotic escalation**
...
- **Pass C — adjudication:** **I5 — erotic escalation**
...
- **Pass A — lexical:** **I10 — eroticized gaze**
  - All four keyword sets converge on erotic gaze / visual revelation of the body: 'tattoo/tattooed/ink/sleeve/covered/neck/shirt' describe body display; 'revealing/reveal/fingertips' in KeyBERT could hint at tracing but no explicit affectionate-contact verb is present — 'tracing' in Main is ambiguous and insufficient alone; 'absently/distracted/emotions' in MMR reinforce a contemplative, observational register rather than active touch. The dominant function is the appreciative, charged gaze at a tattooed body (I10 — erotic gaze). I3 is rejected because no unambiguous affectionate physical contact cue (kiss, hug, hold, caress, undress-as-prelude) appears across any representation.
- **Pass B — contextual:** **I10 — eroticized gaze**
  - The overwhelming majority of sentences describe visual observation or description of tattoos (and piercings) on characters' bodies — this is an erotic/characterizing gaze function (I10), as tattoos serve as markers of identity, danger, or attraction that are visually appraised. BOOK_001_1 and BOOK_004_2 are administrative/non-intimate fragments (I0). BOOK_010_3 ('He picked up my hand and traced the tattoos up my arm') involves actual physical contact — touching/tracing — qualifying as affectionate/intimate physical contact (I3). No explicit sexual acts are present. The topic is clearly centered on tattoos as a visual identity/attraction marker, making I10 dominant at ~85%.
- **Pass C — adjudication:** **I10 — eroticized gaze**
  - Both lexical and contextual consensus converge on I10 (erotic gaze / visual desire without physical contact). The taxonomy confirms primary placement in Attraction & Sexual Tension (2.1) with secondary Character Appearance & Self-Presentation (1.6), consistent with I10: desire is expressed through looking, noticing, and appraising appearance rather than through any affectionate or erotic physical contact. No evidence of kissing, hugging, caressing, undressing-as-prelude, or genital/penetrative acts; I3 and I6 are therefore excluded. The anti-collapse rules are satisfied: I10 is the most specific applicable code.
...
- **Pass C — adjudication:** **I8 — negotiation**
...
- **Pass A — lexical:** **I0 — off target**
  - All four keyword lists are dominated by food, cooking, and dining vocabulary (cake, cream, pie, butter, dessert, soup, salad, bread, chicken, meal, eaten, tasted, melted, carved, exquisite). Supporting terms (parties, rings, giggled, polished, neatly) point to social/domestic gathering context. No affectionate physical contact cues (no kiss, hug, hold, caress, or undress) are present anywhere, so I3 is rejected. No desire, gaze, consent, or erotic language present, ruling out I4, I10, I8, I6. This is a domestic/social scene centered on food and shared meals, coded I0.
- **Pass B — contextual:** **I0 — off target**
  - This topic is overwhelmingly about food, cooking, and domestic/logistical activity — breakfast, sandwiches, soup, croissants, biscuits, goulash, brunch, béchamel. Nearly all sentences are straightforwardly domestic/logistical (I0). BOOK_001_6 ('Delicious, sinfully sweet, incredibly tempting trouble') uses food-adjacent language to hint at desire/temptation without any physical contact, warranting I4. No affectionate physical contact appears anywhere in the topic, so I3 is forbidden. The dominant code is I0 at ~95%.
- **Pass C — adjudication:** **I0 — off target**
  - Lexical and contextual consensus both indicate I0. Taxonomy 4.2 (Ongoing Courtship & Everyday Relational Bonding) with secondary 8.2 (Public, Travel & Leisure Spaces) is consistent with I0: relational maintenance, shared activities, and everyday bonding without affectionate physical contact. No evidence of kissing, hugging, caressing, or undressing-as-prelude; I3 is therefore forbidden. No desire-without-contact, erotic gaze, consent talk, or explicit content signals to redirect to I4, I10, I8, or I6. I0 is confirmed and retained.
...
- **Pass A — lexical:** **I0 — off target**
  - All four keyword lists converge on domestic scheduling and meal logistics: 'dinner, lunch, supper, tonight, tomorrow, eat, having, lunches' (Main); 'meal, eaten, appointment' (KeyBERT); 'appointment, regular, meal' (POS); 'discussing, appointment, arranged, meal, planning' (MMR). This is purely logistical/domestic coordination — scheduling meals and appointments. No affectionate physical contact cues present anywhere, so I3 is rejected. No desire, gaze, consent, or erotic language present, ruling out I4, I10, I8, I6. I0 (domestic/logistical/HEA talk) is the most specific and accurate code.
- **Pass B — contextual:** **I0 — off target**
  - Every sentence in this topic concerns meal logistics: invitations to dinner or lunch, arranging or missing meals, catering menus, and dining plans. There is no affectionate physical contact, no desire expression, no erotic content, and no emotional caretaking beyond hospitality. All sentences fall squarely into I0 (domestic/logistical/relationship-maintenance talk).
- **Pass C — adjudication:** **I0 — off target**
  - All three passes converge on I0. The taxonomy confirms 4.2 Ongoing Courtship & Everyday Relational Bonding with a secondary tag of 8.3b Everyday Props & Communication Media — both are domestic/logistical/relational-maintenance functions with no affectionate physical contact indicated. No lexical or contextual evidence of kissing, hugging, caressing, or undressing-as-prelude; I3 is therefore forbidden. The I0 classification is stable and no reinterpretation is warranted.
...
- **Pass A — lexical:** **I0 — off target**
  - All four keyword lists converge on a shared-meal / food scene. Main is dominated by food items (plate, fork, sandwich, bowl, bread, bacon). KeyBERT confirms eating activity (meal, eaten, feeding, tasted, dipped, swallowed, preparing). POS adds emotional texture (anticipation, enthusiasm, amusement, warmth) consistent with companionable dining but no affectionate-contact cues. MMR reinforces the eating-action frame (dipped, stirred, eagerly, preparing). No kissing, hugging, caressing, or undressing cues appear anywhere; I3 is therefore forbidden. The warmth/anticipation/amusement cluster suggests pleasant social bonding over food, which maps to I0 (domestic/relational logistics and everyday togetherness) rather than any intimacy-escalation code.
- **Pass B — contextual:** **I0 — off target**
  - All sentences in this topic describe mundane mealtime actions: handling forks, spoons, plates, napkins, food, and silverware. There is no affectionate physical contact, no desire, no gaze, no consent talk, and no erotic content. The topic is purely domestic/logistical (eating scenes), coded I0 throughout. BOOK_002_1 references a forked tongue catching droplets, which in context reads as a food/eating action rather than an erotic act sufficient to elevate the code. BOOK_004_1 is a bibliographic reference to a theological text about Communion, also I0.
- **Pass C — adjudication:** **I0 — off target**
  - All three passes converge on I0. The taxonomy confirms 4.2 Ongoing Courtship & Everyday Relational Bonding with a secondary anchor in 8.1 Domestic Spaces & Routines — both are non-contact relational maintenance functions. No lexical or contextual evidence of affectionate physical contact (kiss, hug, hold, caress, or undress-as-prelude) is present, so I3 is forbidden. The content reflects domestic logistics, HEA-oriented bonding talk, and routine couple interaction, which are definitionally I0. No ambiguity warrants manual review.
...
- **Pass A — lexical:** **I0 — off target**
  - All keyword sets point to culinary/domestic activity: cooking, baking, grilling, recipes, chef skills (Main); learning/practice/teaching context (KeyBERT); ability, practice, TV, parties — domestic/social settings (POS); arranged, taught, ability, parties — logistics and skill-sharing (MMR). No affectionate physical contact cues anywhere. I3 rejected: zero kiss/hug/hold/caress/undress signals. No desire, gaze, consent, or erotic language either. This is straightforwardly domestic/logistical content (I0).
- **Pass B — contextual:** **I0 — off target**
  - Every sentence in this topic concerns cooking, food preparation, culinary skill, or kitchen logistics. There is no affectionate physical contact, no desire, no emotional intimacy, and no relational negotiation. All sentences are purely domestic/practical in nature, fitting I0 (domestic/logistical/everyday life content) exclusively.
- **Pass C — adjudication:** **I0 — off target**
  - Lexical and contextual consensus both indicate I0. Taxonomy confirms 4.2 Ongoing Courtship & Everyday Relational Bonding with no secondary code suggesting physical contact. No affectionate contact evidence is present; domestic, logistical, or HEA-oriented relational bonding language dominates. Anti-collapse rules prohibit elevation to I3 without explicit contact evidence. I0 is the correct and most specific code here.
...
- **Pass A — lexical:** **I1 — emotional intimacy**
...
- **Pass A — lexical:** **I0 — off target**
  - All keyword sets point to logistical/domestic planning: concert tickets, tours, cancellations, costs, apology, and scheduling ('tomorrow', 'meantime'). These are practical coordination cues with no affectionate physical contact, desire, or erotic content. I3 rejected: no kiss/hug/hold/caress/undress cues present. 'Winked' in MMR is a minor social gesture insufficient to trigger I3. Consensus is I0 (domestic/logistical/HEA talk).
- **Pass B — contextual:** **I0 — off target**
  - The overwhelming majority of sentences in this topic concern logistics, travel, ticketing, touring, and public/professional events — all coded I0 (domestic/logistical/non-intimate interaction). The single exception is BOOK_002_3, which explicitly describes hand-holding and physical guidance through a crowd, qualifying as affectionate physical contact (I3). No erotic, sexual, or emotionally charged intimacy content is present elsewhere. The dominant code is I0 at ~95% of sentences.
- **Pass C — adjudication:** **I0 — off target**
  - All three passes converge on I0. The taxonomy confirms 4.2 Ongoing Courtship & Everyday Relational Bonding with a secondary tag of 8.3b Everyday Props & Communication Media — both are domestic/logistical/HEA-maintenance functions with no affectionate physical contact indicated. No lexical or contextual evidence of kissing, hugging, caressing, or undressing-as-prelude; I3 is therefore forbidden. The I0 classification is stable and no reinterpretation is warranted.

---

### Topic 37 — Defending A Close Friendship {#topic-h1-37}
...
- **Pass B — contextual:** **I1 — emotional intimacy**
...
- **Pass C — adjudication:** **I1 — emotional intimacy**
...
### Topic 85 — Offering and Refusing An Apology {#topic-h1-85}
...
- **Pass A — lexical:** **I0 — off target**
  - All keyword lists point to relationship-status and logistics language: 'date/dating/dated/dates/together/we/two' (Main) describe the relational context of a couple; 'engaged/partners/longest/fitting/officially/forming/intend' (KeyBERT/POS/MMR) reinforce commitment-status and HEA/relationship-definition talk. 'Playfully/nods/honestly/admit' suggest conversational tone, not physical contact. No affectionate-contact cues (kiss, hug, hold, caress, undress) are present anywhere, so I3 is forbidden. No desire/gaze/erotic/explicit cues, so I4/I10/I6 are excluded. The dominant function is domestic/relational logistics and relationship-status definition → I0.
- **Pass B — contextual:** **I0 — off target**
  - The overwhelming majority of sentences concern relationship logistics, social togetherness, dating history, breakups, and going out — all domestic/relational-status talk coded I0. Three sentences (BOOK_003_4, BOOK_004_3, BOOK_004_4) express emotional vulnerability, reassurance, or open emotional reciprocation, coded I2. No sentence contains affectionate physical contact, so I3 is forbidden. No desire-without-contact, erotic gaze, or explicit acts are present. I0 exceeds 70%, making it the dominant code.
- **Pass C — adjudication:** **I0 — off target**
  - Lexical and contextual consensus both converge on I0. The taxonomy placement under 4.5 Reconciliation, Commitments & HEA (with secondary 4.2 Ongoing Courtship & Everyday Relational Bonding) is consistent with domestic logistics, future-planning talk, and HEA declarations — none of which constitute affectionate physical contact. Anti-collapse rules prohibit elevation to I3 absent contact evidence, and no such evidence is present. I0 is the correct and most specific code; no reinterpretation or split is warranted.
...
- **Pass A — lexical:** **I2 — reassurance**
  - All four keyword lists converge on verbal/communicative exchange cues: 'whispered', 'softly', 'replied', 'thank', 'mumbled', 'confessed', 'tentatively', 'hesitation', 'solemnly', 'kindly', 'eagerly'. These signal emotionally attentive dialogue — reassurance, caretaking, and supportive conversation — consistent with I2 (emotional support/reassurance). No affectionate physical contact cues (kiss, hug, hold, caress, undress) are present anywhere, so I3 is rejected. No desire/gaze cues for I4/I10, no explicit content for I6, no coercion for I9, no consent negotiation for I8, and no domestic/HEA logistics for I0.
- **Pass B — contextual:** **I2 — reassurance**
- **Pass C — adjudication:** **I2 — reassurance**
  - Lexical and contextual consensus both indicate I2. Taxonomy confirms 4.6 Emotional Safety, Reassurance & Caretaking with no secondary code suggesting physical contact. No affectionate physical contact evidence is present, so I3 is forbidden per anti-collapse rules. The topic cleanly maps to reassurance and caretaking functions without domestic/logistics/HEA content that would push it to I0. KEEP as I2 is appropriate.
...
- **Pass A — lexical:** **I0 — off target**
  - Main keywords (sleep, asleep, tired, wake, exhausted, night) point to rest/domestic routine with no intimacy signal — I0. POS keywords (destination, decades, activities, threats, creatures, instincts) are abstract/logistical with no contact cues — I0. MMR keywords (warming, drifted, activities, threats, instincts, climb) suggest ambient atmosphere or physical movement but no affectionate contact — I0. KeyBERT introduces some emotional arousal cues (anxious, excited, trembling, moaned, instincts, praying) that could hint at desire or tension, nudging toward I4, but 'moaned' in a sleep/exhaustion context is ambiguous and insufficient to override the dominant rest/domestic frame. No affectionate physical contact cues (kiss, hug, hold, caress) appear in any representation, so I3 is rejected per anti-collapse rules. Consensus is I0 (domestic/logistical/rest context).
- **Pass B — contextual:** **I0 — off target**
  - All sentences in this topic describe sleep states, exhaustion, wakefulness, or rest-related observations. There is no affectionate physical contact, desire, gaze, consent talk, or any other intimacy function present. The topic is purely about characters sleeping or being tired, which falls under I0 (domestic/logistical/neutral narrative content).
- **Pass C — adjudication:** **I0 — off target**
  - All three passes converge on I0. Taxonomy confirms 4.6 Emotional Safety, Reassurance & Caretaking as dominant, with paranormal/immortal beings as secondary context. No lexical or contextual evidence of affectionate physical contact (kiss, hug, hold, caress, or undress-as-prelude) is present, so I3 is forbidden per anti-collapse rules. The content reflects relational reassurance and caretaking dynamics — potentially within a paranormal pairing — without crossing into physical intimacy, desire expression, or explicit acts. I0 is the correct and most specific code. No split or reinterpretation is warranted.
...
- **Pass B — contextual:** **I7 — aftercare**
...
- **Old taxonomy:** 7.4 — Unwanted or Coercive Sexual Contact
- **New category:** **I9 — coercive sexuality**
- **Mixed:** False
- **Adjudication action:** `RETAXONOMIZE`
...
- **Pass C — adjudication:** **I9 — coercive sexuality**
...
### Topic 100 — Promising to Find Her {#topic-h1-100}

- **Old taxonomy:** 9.2 — Promise, Vow & Future-Tense Speech Acts
- **New category:** **I0 — off target**
- **Mixed:** False
- **Adjudication action:** `KEEP`
...
>
> She won’t be able to leave, to rest, to pass over, whatever it is, until we find her.” “
...
| 1 — Straps Sliding Down Her Arms | 2.3 — Explicit Sexual Acts | S5 — practical care everyday | True |
...
| 340 — Patience Tested Through Small Trials | 4.6 — Emotional Safety, Reassurance & Caretaking | UNKNOWN | True |
...
| 340 — Patience Tested Through Small Trials | 4.6 — Emotional Safety, Reassurance & Caretaking | H4_5 — external protection physical | True |
