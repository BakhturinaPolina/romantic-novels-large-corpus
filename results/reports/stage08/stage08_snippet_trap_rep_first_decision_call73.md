...
**Keep `configs/stage08/stage08_labeling.yaml` → `v3_topic_labeling` for the full 148-topic corpus.**
...
2. **Relabel:** `scripts/stage08/run_stage08_snippet_trap_relabel.sh` → `v3_rep_first`, output suffix `snippet_trap_rep_first`
3. **Compare:** [`comparison_call73.csv`](../../stage08_llm_labeling/placeholder_v4_call73/snippet_trap/comparison_call73.csv)
...
Output: `results/stage08_llm_labeling/placeholder_v4_call73/snippet_trap/labels_pos_*_snippet_trap_rep_first_topics.json`


| Artifact | Path |
|----------|------|
| Production labels | `results/stage08_llm_labeling/placeholder_v4_call73/production/labels_pos_*_v3_topic_labeling.json` |
| Snippet-trap relabel | `results/stage08_llm_labeling/placeholder_v4_call73/snippet_trap/labels_pos_*_snippet_trap_rep_first*.json` |
| Comparison CSV | `results/stage08_llm_labeling/placeholder_v4_call73/snippet_trap/comparison_call73.csv` |
| Gold rep-first run | `results/stage08_llm_labeling/placeholder_v4_call73/gold_regression/gold30_rep_first_report_20260630_221424.csv` |
| A/B script | `scripts/stage08/run_stage08_gold_regression_rep_first.sh` |
