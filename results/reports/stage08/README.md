...
| [`stage08_production_model_decision_call73.md`](stage08_production_model_decision_call73.md) | Model choice (Sonnet) |
| [`stage08_prompting_research_design_call73.md`](stage08_prompting_research_design_call73.md) | OVAT prompt sweep design |
| [`stage08_snippet_trap_rep_first_decision_call73.md`](stage08_snippet_trap_rep_first_decision_call73.md) | Snippet-trap relabel decision |
