...
3. **Stage08 LLM pilot** — ~20 topics from the **151 usable** list (not call 55); filter on `exclude_from_axes == false`.
...
| **Stage08–09 taxonomy schema / merges** | [`stage08_stage09_taxonomy_improvement_notes_call59.md`](stage08_stage09_taxonomy_improvement_notes_call59.md) — add **call_73 section** or sibling `..._call73.md` | This file §4 |
