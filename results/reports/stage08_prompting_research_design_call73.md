...
```bash
bash scripts/run_stage08_prompt_sweep_call73.sh phase0b   # D2 only
bash scripts/run_stage08_prompt_sweep_call73.sh phase_a
bash scripts/run_stage08_prompt_sweep_call73.sh phase_b
bash scripts/score_stage08_prompt_sweep.py --sweep-dir results/stage08_llm_labeling/prompt_sweeps/call73
```
