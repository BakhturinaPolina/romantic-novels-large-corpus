...
#   ./scripts/stage03/run_v3_remote_model.sh sample          # once, after CSVs are in place
#   ./scripts/stage03/run_v3_remote_model.sh mpnet encode    # CPU encode, resumable (slow)
#   ./scripts/stage03/run_v3_remote_model.sh mpnet tune      # after encode finishes (needs GPU for cuML)
#   ./scripts/stage03/run_v3_remote_model.sh minilm6 encode
#   ./scripts/stage03/run_v3_remote_model.sh minilm6 tune
set -euo pipefail
