...
#
# Usage:
#   ./scripts/run_v4_granular_phase2.sh l12
#   ./scripts/run_v4_granular_phase2.sh l6
#   ./scripts/run_v4_granular_phase2.sh mpnet
set -euo pipefail
...
model_config() {
  case "$1" in
    l12)
      ...
      TRAIN_CONFIG="configs/train_v4_l12_granular_phase1.yaml"
    ...
    l6)
      ...
      TRAIN_CONFIG="configs/train_v4_l6_granular_phase1.yaml"
    ...
    mpnet)
      ...
      TRAIN_CONFIG="configs/train_v4_mpnet_granular_phase1.yaml"
...
"$PY" scripts/granular_select_phase2_candidates.py \
  --trials "$TRIALS_PATH" \
  --run-id "$PHASE1_RUN" \
