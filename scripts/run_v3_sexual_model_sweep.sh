...
# Usage: ./scripts/run_v3_sexual_model_sweep.sh [sonnet|lumimaid|grok|dolphin|compare|all]
case "${1:-compare}" in
  ...
  compare)  "$PY" scripts/compare_v3_sexual_model_labels.py ;;
  all)
    ...
    "$PY" scripts/compare_v3_sexual_model_labels.py
    ;;
