...
#
# Usage:
#   bash scripts/stage08/run_stage08_prompt_sweep_call73.sh phase0b
#   bash scripts/stage08/run_stage08_prompt_sweep_call73.sh phase_a
#   bash scripts/stage08/run_stage08_prompt_sweep_call73.sh phase_b [BASE_PROMPT_VERSION]
#   bash scripts/stage08/run_stage08_prompt_sweep_call73.sh phase_c [FINAL_PROMPT_VERSION]
#
...
case "$PHASE" in
  ...
  phase_c)
    ...
    ;;
  phase_c8)
    exec bash "${ROOT}/scripts/stage08/run_stage08_c8_character_names_sweep.sh"
    ;;
  *)
...
echo "  python scripts/stage08/score_stage08_prompt_sweep.py --sweep-dir ${SWEEP_DIR}"
