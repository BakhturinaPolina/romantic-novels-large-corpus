...
OUT_DIR = ROOT / "results/stage08_llm_labeling/placeholder_v4_call73/sexual_precision"
GOLD = ROOT / "configs/stage08/stage08_v3_sexual_subset_gold.yaml"
REPORT = ROOT / "results/reports/stage08/stage08_v3_sexual_model_comparison.md"
...
def main() -> None:
    ...
    lines = [
        ...
        "",
        "Gold reference: `configs/stage08/stage08_v3_sexual_subset_gold.yaml` (28 topics).",
