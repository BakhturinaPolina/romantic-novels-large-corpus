...
#
# Usage:
#   bash scripts/stage08/run_stage08_placeholder_v4_call.sh          # call 73, full run
#   bash scripts/stage08/run_stage08_placeholder_v4_call.sh 73 --limit-topics 20   # pilot
#
...
CFG="${ROOT}/configs/stage08/stage08_labeling.yaml"
