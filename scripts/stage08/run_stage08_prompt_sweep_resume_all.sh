...
echo "=== Phase A resume ==="
bash scripts/stage08/run_stage08_prompt_sweep_call73.sh phase_a_resume

echo "=== Score Phase A + 0b ==="
"$ROOT/.venv/bin/python" scripts/stage08/score_stage08_prompt_sweep.py --sweep-dir "$SWEEP_DIR" --panel pilot20
...
bash scripts/stage08/run_stage08_prompt_sweep_call73.sh phase_c "$FINAL_PROMPT"

echo "=== Final score (full30) ==="
"$ROOT/.venv/bin/python" scripts/stage08/score_stage08_prompt_sweep.py --sweep-dir "$SWEEP_DIR" --panel full30
