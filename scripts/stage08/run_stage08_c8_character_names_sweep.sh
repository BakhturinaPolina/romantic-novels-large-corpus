...
#
# Usage:
#   bash scripts/stage08/run_stage08_c8_character_names_sweep.sh
#
...
_score_one() {
  local path="$1"
  "$ROOT/.venv/bin/python" scripts/stage08/score_stage08_prompt_sweep.py \
    --sweep-dir "$SWEEP_DIR" \
...
spec = importlib.util.spec_from_file_location(
    ...
    root / "scripts/stage08/score_stage08_prompt_sweep.py",
)
