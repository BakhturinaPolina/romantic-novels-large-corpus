...
#
# Usage:
#   scripts/run_stage08_full_corpus.sh           # resume if partial output exists
#   scripts/run_stage08_full_corpus.sh --no-resume
#
...
CONFIG="${ROOT}/configs/stage08_labeling.yaml"
