...
def read_split_csv(csv_path: Path, sentence_column: str = "sentence") -> pd.DataFrame:
    """Read a Stage 01 sentence split and apply cleaning."""
...
def load_train_eval(
    train_csv: Path, eval_csv: Path, sentence_column: str = "sentence"
) -> dict[str, Any]:
    """Load train/eval splits into a single payload."""
