...
```bash
python -m src.stage09_category_mapping.stage2_radway_functions.scripts.update_model_with_radway \
  --merged-json results/stage09_category_mapping/stage2_radway_functions/taxonomy_with_radway.json \
...
|--------|------|-------------|
| Taxonomy | `results/stage09_category_mapping/stage1_theory_driven_categories/taxonomy_mappings_*.json` | Stage 1 taxonomy mappings |
...
|--------|------|-------------|
| Merged JSON | `results/stage09_category_mapping/stage2_radway_functions/taxonomy_with_radway.json` | Taxonomy + Radway mappings |
...
- `--taxonomy-json`: Path to Stage 1 taxonomy JSON or BERTopic model
...
- [Research Report](../../../results/reports/01_stage_reports/stage09_category_mapping/03_stage2_radway_functions/stage09_stage3_radway_narrative_functions_research_report.md) — Methodology and results
