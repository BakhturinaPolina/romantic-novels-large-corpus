...
_CODE_ALIASES: Dict[str, str] = {
    ...
    "HEA": "H2_5",
    "FINAL_PAYOFF": "H2_5",
    "FINAL_RELATIONAL_PAYOFF": "H2_5",
    "REPAIR": "H2_3",
    "RECONCILIATION": "H2_3",
    "COMMITMENT": "H2_4",
    "MUTUAL_COMMITMENT": "H2_4",
    "PUBLIC_UNION": "H2_6",
    "WEDDING": "H2_6",
    "LOVE_TOKEN": "H2_7",
    "COMMITMENT_SYMBOL": "H2_7",
    "CONFESSION": "H2_1",
    "APOLOGY": "H2_2",
    "4.5": "H2_3",
    "4.5.1": "H2_3",
...
CODE_TO_RAX: Dict[str, List[str]] = {
    ...
    "H2_2": ["RAX_generic_confession_apology"],
    "H2_3": ["RAX_repair"],
    "H2_4": ["RAX_mutual_commitment"],
    "H2_5": ["RAX_final_relational_payoff"],
    "H2_6": ["RAX_public_union"],
    "H2_7": ["RAX_commitment_symbols"],
    "H2_8": ["RAX_mutual_commitment"],
    # H3 security
